...
//public class MidiPortDeviceManager : IInputManager, IOutputManager
//{
//	private List<InputDevice> midiPorts = new List<InputDevice>();
//	private Dictionary<InputDevice, Queue<byte>> buffers = new Dictionary<InputDevice, Queue<byte>>();
...
//		inputDevice.EventReceived += MidiPortDataReceived;

//		try
//		{
//			inputDevice.StartEventsListening();
//			midiPorts.Add(inputDevice);
//			buffers.Add(inputDevice, new Queue<byte>());

//			byte[] readyMsg = ParseSysEx.GenerateSysEx(0x0000, SysEx.DeviceReady, []);
//			OutputDevice outputDevice = OutputDevice.GetByName(portName);
//			outputDevice.SendEvent(new NormalSysExEvent(readyMsg));
...
//	{
//		InputDevice input = InputDevice.GetByName(portName);
//		if (serialPort != null)
//			//{
//			//	byte[] MidiReset = { 0xFF };
...
//		{
//			RemoveConnection(inputDevice.ToString());
//		}
//	}

//	private void MidiPortDataReceived(object sender, MidiEventReceivedEventArgs e)
//	{
